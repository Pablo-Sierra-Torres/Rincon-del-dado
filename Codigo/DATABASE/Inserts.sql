...
INSERT INTO `productos` (`Catán`,`Sois los primeros colonos en llegar a la isla de Catan. Muy pronto empiezan a aparecer los primeros poblados y las primeras carreteras, mientras que los fértiles terrenos os aportan abundantes materias primas.
...
INSERT INTO `productos` (`Monopoly`,`Monopoly es un juego de mesa clásico y fácil de jugar que puede ser disfrutado por 2-8 jugadores. Evita la bancarrota y conviértete en el jugador más rico que juegue para ganar este juego.`,
                        `monopoly.png`,40.99,100,`Clásicos`);

INSERT INTO `productos` (`Parchis`,`El Parchís es un juego de carreras, heredero del juego de origen indio denominado Parchisi.
...
INSERT INTO `productos` (`Ajedrez`,`El ajedrez es un juego que se desarrolla sobre un tablero y que enfrenta a dos personas. Cada jugador cuenta con dieciséis piezas que puede desplazar, respetando ciertas reglas, sobre el tablero que está dividido en sesenta y cuatro casilleros, conocidos como escaques.
...
INSERT INTO `productos` (`Pokemon`,`¡Conviértete en un Entrenador Pokémon y combate contra otros Entrenadores usando increíbles Pokémon en JCC Pokémon! Los Entrenadores usan ataques para dejar Fuera de Combate a los Pokémon del otro y ganar cartas de Premio. El primer jugador en coger las 6 cartas de Premio gana la partida.`,
                        `pokemon.jpg`,999.99,1000,`TCG`);

INSERT INTO `productos` (`Yu-gi-oh`,`Yu-Gi-Oh! Juego de Cartas Coleccionables en español (también conocido con su nombre en inglés como Yu-Gi-Oh! Trading Card Game y usualmente con la abreviatura TCG, adaptada al español como JCC) es parte del juego de cartas basado en el fenómeno manga y anime de Yu-Gi-Oh!, siendo este producido por Konami como su dueño actual.
...
INSERT INTO `productos` (`Magic`,`En Magic: The Gathering cada jugador, debe derrotar a su enemigo usando sus poderes: criaturas mágicas, artefactos, y encantamientos, extrayendo el poder o maná de sus tierras, algunas también con sus propios poderes.`,
