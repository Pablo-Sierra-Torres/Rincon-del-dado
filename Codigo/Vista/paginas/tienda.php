                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4">
                            ...
                            <a href="../Controlador/controladorProducto.php?nombreProducto=<?php echo($Estrategia[$i]->Nombre)?>"><img src="../Vista/imgs/tienda/<?php  echo($Estrategia[$i]->Imagen);?>" class="card-img-top" alt="..."></a>
                              ...
                              <p class="d-none"><?php  echo($Estrategia[$i]->Precio);?></p>    
                              <button id="<?php echo $Estrategia[$i]->Nombre ?>" class="btn btn-primary">Comprar <?php  echo($Estrategia[$i]->Precio);?>€</button>
                              </div>
                            </div>
                          </div>
                        ...
                        <?php   
                          ...
                          <div class="col-lg-4">
                            ...
                            <a href="../Controlador/controladorProducto.php?nombreProducto=<?php echo($Clasicos[$i]->Nombre)?>"><img src="../Vista/imgs/tienda/<?php  echo($Clasicos[$i]->Imagen);?>" class="card-img-top" alt="..."></a>
                              ...
                              <p class="d-none"><?php  echo($Clasicos[$i]->Precio);?></p>    
                              <button  id="<?php echo $Clasicos[$i]->Nombre ?>"  class="btn btn-primary">Comprar <?php  echo($Clasicos[$i]->Precio);?>€</button>
                              </div>
                            </div>
                          </div>
                        ...
                        <?php   
                          ...
                          <div class="col-lg-4">
                            ...
                            <a href="../Controlador/controladorProducto.php?nombreProducto=<?php echo($TGC[$i]->Nombre)?>"><img src="../Vista/imgs/tienda/<?php  echo($TGC[$i]->Imagen);?>" class="card-img-top" alt="..."></a>
                              ...
                              <p class="d-none"><?php  echo($TGC[$i]->Precio);?></p>  
                              <button  id="<?php echo $TGC[$i]->Nombre ?>" class="btn btn-primary">Comprar <?php  echo($TGC[$i]->Precio);?>€</button>
                              </div>
                            </div>
                          </div>
          ...
          <div class="col-lg-3" id="carrito">
           ...
           <template id="card-template">
            <div class="card" style="width: 18rem;" id="item-carrito">
              ...
              <div class="card-body">
                <h5 class="card-title" id ='objetos'>Monopoly</h5>
                <hr>
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <button type="button" class="btn btn-primary pbt" id="precio">40,99€</button>
                </div>
                <div class="row">
                 <div class="col-2">
            ...
            <template id="template-end">    
              <h3 style="text-align: center;" id="T-precio">Total: 00.00€</h3>
              <h3 style="text-align: center;" id="T-cantidad">Total: 0</h3>
              ...
              <script src="../Vista/javascript/realizarCompra.js"></script>
              <script src="../Vista/javascript/comprobarCompra.js"></script>
            </template>
                  ...
                  <div action="" role="form">
                    <div class="form-group">
                      <div class="container">
                        ...
                        <label for="id-form-pago" class="form-label"> Metodo de pago 
