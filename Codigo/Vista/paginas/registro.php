            ...
            <div class="row">  
              <div class="col-lg-6">
                ...
                <div class=" input-group mb-3">
                    ...
                    <input id="tlfFijo" type="text" class="form-control" placeholder="910234567" aria-label="Username" aria-describedby="basic-addon1" name="telefonoFijo" required>     
                </div>
              </div>  
              <div class="col-lg-6">
                <h5>T. Movil</h5>
                <div class=" input-group mb-3">
                    ...
                    <input id="tlfMovil" type="text" class="form-control" placeholder="601234567" aria-label="Username" aria-describedby="basic-addon1" name="telefonomovil" required>
                </div>
              </div> 
            </div>       
              <hr>
