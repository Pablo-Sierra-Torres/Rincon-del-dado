...
<html>
    ...
    <head>
        ...
        <script defer src="../Vista/javascript/login.js"></script>
          ...
          <div class="col-lg-12" id="cajalogin">
            ...
            <form id = "formularioLogin" method="POST" action="controladorLogin.php">
              ...
              <div class=" input-group mb-3">
                ...
                <input id = "correoInput" type="text" class="form-control" placeholder="ejemplo@gmail.com" aria-label="Username" aria-describedby="basic-addon1" name="usuario" pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" required>
              </div>
              ...
              <div class=" input-group mb-3">
                ...
                <input id="passInput" type="password" class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1" name="pass" required>
